...
/*! @name PIO3_3 (coord A13), U12[12]/P4_16-ENET_MDIO
  @{ */
#define BOARD_ENET_MDIO_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_ENET_MDIO_PORT 3U   /*!<@brief PORT device name: 3U */
#define BOARD_ENET_MDIO_PIN 3U    /*!<@brief 3U pin index: 3 */
                                  /* @} */
...
/*! @name FC3_CTS_SDA_SSEL0 (coord A1), J13[4]/U27[2]/P0_25-SPIFI_IO1
  @{ */
/* @} */

...
- options: {prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: M13, peripheral: SPIFI0, signal: SPIFI_SCK, pin_signal: N.C.4}
  - {pin_num: M7, peripheral: SPIFI0, signal: SPIFI_IO0/SPIFI_MOSI, pin_signal: N.C.0}
  - {pin_num: K8, peripheral: SPIFI0, signal: SPIFI_IO1/SPIFI_MISO, pin_signal: N.C.1}
  - {pin_num: L9, peripheral: SPIFI0, signal: 'SPIFI_IO, 3', pin_signal: N.C.2}
  - {pin_num: M9, peripheral: SPIFI0, signal: 'SPIFI_IO, 2', pin_signal: N.C.3}
  - {pin_num: N7, peripheral: SPIFI0, signal: SPIFI_CSN, pin_signal: Flash_Enable0}
...
- pin_list:
  ...
  - {pin_num: C4, peripheral: ENET, signal: ENET_MDIO, pin_signal: Flash_Enable1}
  - {pin_num: A4, peripheral: ENET, signal: ENET_MDC, pin_signal: VDD7}
